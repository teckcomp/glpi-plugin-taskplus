 ...
 *
 * Mesmo padrão do front/panel.php: o controlador entrega TUDO pronto —
 * o payload inicial (últimos 30 dias, o default do historyRange) vai
 * embutido como JSON na página; o public/js/history.js renderiza e, a
 * cada mudança de período no ajax/history.php, re-renderiza com o
 * payload da resposta.
 */
...
Html::header(
    __('Tarefas — Histórico', 'taskplus'),
    '', // Html::header ignora o 2º argumento no GLPI 11 (lição do PP, Bloco 4a)
    'tools',
    Today::class
);

$payload = History::payload((int) Session::getLoginUserID());
